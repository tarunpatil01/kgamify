...
export default function Applications({ isDarkMode }) {
  ...
  return (
    ...
    >
      ...
      {/* Filters */}
      <div className="card-kgamify p-3 sm:p-4 mb-3 sm:mb-4 grid grid-cols-1 lg:grid-cols-4 gap-3">
        <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 col-span-1 lg:col-span-1">
          <div>
      ...
      {companyFilter !== 'all' && (
        <div className="mb-3 sm:mb-4 text-sm opacity-80">
