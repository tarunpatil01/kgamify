      ...
      <div className="w-full max-w-md mx-auto rounded-3xl shadow-2xl border bg-white border-orange-200 p-6 sm:p-10 relative z-10">
          ...
          <form onSubmit={submitBasic} className="space-y-5">
            ...
            <div className="text-center pt-4 border-t border-gray-200/50">
              ...
              <p className="text-[12px] leading-5 text-center text-black/70 mt-3">
                ...
                <a href="/terms-of-service?from=register" className="text-[#ff8200] hover:text-[#e57400] font-semibold">Terms of Service</a>{' '}and acknowledge our{' '}
                <a href="/privacy-policy?from=register" className="text-[#ff8200] hover:text-[#e57400] font-semibold">Privacy Policy</a>{' '}and{' '}
                <a href="/cookies?from=register" className="text-[#ff8200] hover:text-[#e57400] font-semibold">Cookie Policy</a>.
              </p>
            </div>
          </form>
        )}
        {step===2 && (
          <form onSubmit={verifyOtp} className="space-y-6">
            <div><label className="block font-semibold text-black mb-2">OTP Code <span className="text-red-500">*</span></label><input value={otpCode} onChange={e=>setOtpCode(e.target.value)} maxLength={6} placeholder="123456" className="tracking-widest text-center text-lg w-full px-4 py-3 rounded-xl border font-medium bg-white border-gray-900 text-black focus:ring-2 focus:ring-[#ff8200] outline-none transition placeholder-gray-400" required /></div>
