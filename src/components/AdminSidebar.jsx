...
import { FaBuilding, FaUser, FaSignOutAlt, FaKey, FaBriefcase, FaRegCommentDots, FaCreditCard } from 'react-icons/fa';
  ...
  return (
    <aside className={containerClass}> 
      ...
      <nav className="space-y-1 flex-1">
        ...
        <Item to="/admin/tickets" icon={FaRegCommentDots} label="Support Tickets" />
        <Item to="/admin/plans" icon={FaCreditCard} label="Plan Purchases" />
